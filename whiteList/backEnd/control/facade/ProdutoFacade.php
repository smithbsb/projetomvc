<?php
require_once(CONTROL_BO . '/ProdutoBO.php');
...
function readProdutos ($d, $msg_ret, $data_ret) {
    @session_start();
    
    $produtoBO         = new backEnd\control\facade\bo\ProdutoBO();    
    $list_of_produtos  = $produtoBO->readProdutos();
    
    require_once(VIEW . '/produto/produto.View.php');
    produtoView($list_of_produtos, $msg_ret, '');
    exit();
}
